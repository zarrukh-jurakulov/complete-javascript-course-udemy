...
// 4.
const playersFinal = [...players1, 'Tiago', 'Coutinho', 'Periscic'];
...
const arr = [7, 8, 9];
const badNewArrray = [1, 2, arr[0], arr[1], arr[2]];
console.log(badNewArrray);
...
// Objects
const newRestaurant = { foundIn: 1998, ...restaurant, foundecr: 'Guiseppe' };
